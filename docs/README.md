...
| [troubleshooting.md](troubleshooting.md) | Common pitfalls, log lines decoded |

The top-level [README.md](../README.md) has the elevator pitch, the LocalJob-vs-SingletonJob decision table, and a 30-line quickstart.
